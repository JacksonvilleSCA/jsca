...
const AdminViewEssay = () => {
  ...
  const fetchStudentData = async (studentId) => {
    try {
      ...
      console.log(student.essay);
      setStudentData(student);
      if (typeof student.essay === "string") {
        const strippedDetails = student.essay.replace(/<\/?p>/g, "");
                  ...
                  {studentData && (
                    <div>
                      ...
                      <a
                        ...
                        href={`/adminViewForm?studentId=${studentData._id}`}
                        role="button"
                        onClick={() => handleViewForm(studentData._id)}
                      >
                        {" "}
                        View Form{" "}
                      </a>
